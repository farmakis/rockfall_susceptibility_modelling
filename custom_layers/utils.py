...
class Dense(Layer):
	...
	def __init__(self, units, activation=tf.nn.relu, initializer='glorot_normal', bn=False):
	...
	def build(self, input_shape):
		...
		self.dense = tf.keras.layers.Dense(
			units=self.units, activation=self.activation, kernel_initializer=self.initializer, use_bias=not self.bn)
